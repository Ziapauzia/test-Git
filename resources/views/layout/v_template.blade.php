...
<!-- Bootstrap 3.3.7 -->
<link rel="stylesheet"
href="{{asset('asset/adminLTE')}}/bower_components/bootstrap/dist/css/bootstrap.min.css">
<!-- Font Awesome -->
<link rel="stylesheet" href="{{asset('asset/adminLTE')}}/bower_components/fontawesome/css/font-awesome.min.css">
<!-- Ionicons -->
<link rel="stylesheet"
href="{{asset('asset/adminLTE')}}/bower_components/Ionicons/css/ionicons.min.css">
<!-- Theme style -->
...
<a href="#">
<div class="pull-left">
<img src="{{asset('adminLTE')}}/dist/img/user2-160x160.jpg" class="imgcircle" alt="User Image">
</div>
<h4>
Support Team
...
<li><a href="#control-sidebar-home-tab" data-toggle="tab"><i class="fa fahome"></i></a></li>
<li><a href="#control-sidebar-settings-tab" data-toggle="tab"><i class="fa fagears"></i></a></li>
</ul>
<!-- Tab panes -->
...
<label class="control-sidebar-subheading">
Delete chat history
<a href="javascript:void(0)" class="text-red pull-right"><i class="fa fa-trasho"></i></a>
</label>
</div>
<!-- /.form-group -->
</form>
...
<!-- Bootstrap 3.3.7 -->
<script
src="{{asset('asset/adminLTE')}}/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
<!-- SlimScroll -->
<script src="{{asset('asset/adminLTE')}}/bower_components/jqueryslimscroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
